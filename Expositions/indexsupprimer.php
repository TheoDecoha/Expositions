...
<div id="global">
	...
	<div id="contenu">
		<h2>Voici la liste des lieux d'expositions que vous pouvez supprimer</h2>
		<?php
		session_start();
		if (isset($_SESSION['validuser'])) 
		{
			...
			if ($id_connexion->connect_errno ==0) 
			{
				...
				while ($ligne = $resultat->fetch_object())
				{
					...
					echo $numero.' - <a href="supprimer.php?numero='.$numero.'">'.$ligne->nom_lieu.'</a><br><br>';
				}
			}
		}
		else 
		{
		echo "<h4 style='color:red'>Impossible de supprimer un lieux d'expositions !<h4>";
	...
	<footer>
		Retrouver toutes les actualités sur les expositions sur notre site : <a target="_blank" href="http://www.angers.fr">www.angers.fr</a>
	</footer>
